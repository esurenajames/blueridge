<div class="fixed left-0 top-0 w-64 h-full p-4 z-50 sidebar-menu transition-transform px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            <a class="flex items-center px-4 py-2 {{ request()->routeIs('main-secretary') ? 'bg-gray-200 dark:bg-gray-700 dark:text-gray-200' : 'hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200' }} text-gray-700 dark:text-gray-200 rounded-md" href="{{ route('main-secretary') }}">
            ...
            <a class="flex items-center px-4 py-2 mt-2 {{ request()->routeIs('request-table') ? 'bg-gray-200 dark:bg-gray-700 dark:text-gray-200' : 'hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200' }} text-gray-700 dark:text-gray-200 rounded-md" href="{{ route('request-table') }}">
                ...
                <span class="mx-4 font-medium text-[17px]">Form Request List</span>
            </a>
            ...
            <a class="flex items-center px-4 py-2 mt-2 {{ request()->routeIs('/approval-management') ? 'bg-gray-200 dark:bg-gray-700 dark:text-gray-200' : 'hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200' }} text-gray-700 dark:text-gray-200 rounded-md" href="{{ route('/approval-management') }}">
                ...
                <span class="mx-4 font-medium text-[17px] whitespace-nowrap">Approval Manager</span>
            </a>

            <a class="flex items-center px-4 py-2 mt-2 {{ request()->routeIs('expense-table') ? 'bg-gray-200 dark:bg-gray-700 dark:text-gray-200' : 'hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200' }} text-gray-700 dark:text-gray-200 rounded-md" href="{{ route('expense-table') }}">
                <svg class="w-5 h-5" fill="#c0c0c0" height="64px" width="64px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 219.376 219.376" xml:space="preserve">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                ...
                <span class="mx-4 font-medium text-[17px]">Budget Manager</span>
            </a>

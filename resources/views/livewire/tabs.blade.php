<div>
    <div class="space-y-5 rounded-md bg-white p-3 mt-5 shadow-md w-3/4 mx-auto mt-7">
        ...
        <ul class="-mb-px flex flex-wrap items-center gap-1 text-md ">
            ...
            <li class="flex-1">
                <a href="#" data-tab="view-all" class="tab-link whitespace-nowrap relative flex items-center justify-center gap-2 px-2 py-2 bg-white rounded-t-md hover:text-blue-800 overflow-hidden">
                    <!-- Larger SVG icon -->
                    ...
                    View All
                    <!-- Badge -->
                    <span class="rounded-full bg-gray-100 px-2 py-0.5 text-xs font-semibold text-gray-500">{{ $counts['view_all'] }}</span>
                </a>
            </li>
            

            <li class="flex-1">
                <a href="#" data-tab="approval" class="tab-link whitespace-nowrap relative flex items-center justify-center gap-2 px-2 py-2 bg-white rounded-t-md hover:text-blue-800 overflow-hidden">
                    <!-- SVG icon -->
            ...
            <li class="flex-1">
                <a href="#" data-tab="view-all" class="tab-link whitespace-nowrap relative flex items-center justify-center gap-2 px-2 py-2 bg-white rounded-t-md hover:text-blue-800 overflow-hidden">
                    ...
                    Request Form
                    <!-- Badge -->
                    <span class="rounded-full bg-gray-100 px-2 py-0.5 text-xs font-semibold text-gray-500"></span>
                </a>
            </li>
            
            <li class="flex-1">
                <a href="#" data-tab="quotation" class="tab-link whitespace-nowrap relative flex items-center justify-center gap-2 px-2 py-2 bg-white rounded-t-md hover:text-blue-800 overflow-hidden">
                    <!-- SVG icon -->
                    <svg class="w-5 h-5 fill-current text-gray-500" viewBox="0 0 64 64">
                        <path fill="#808080" d="M62.828,29.172l-28-28C34.078,0.422,33.062,0,32,0H4C1.789,0,0,1.789,0,4v28 c0,1.062,0.422,2.078,1.172,2.828l28,28C29.953,63.609,30.977,64,32,64s2.047-0.391,2.828-1.172l28-28 C64.391,33.266,64.391,30.734,62.828,29.172z M20,28.004c-4.418,0-8-3.582-8-8s3.582-8,8-8s8,3.582,8,8S24.418,28.004,20,28.004z"/>
                    </svg>
            ...
            <li class="flex-1">
                <a href="#" data-tab="purchase-request" class="tab-link whitespace-nowrap relative flex items-center justify-center gap-2 px-2 py-2 bg-white rounded-t-md hover:text-blue-800 overflow-hidden">
                    <!-- Larger SVG icon -->
            ...
            <li class="flex-1">
                <a href="#" data-tab="purchase-order" class="tab-link whitespace-nowrap relative flex items-center justify-center gap-2 px-2 py-2 bg-white rounded-t-md hover:text-blue-800 overflow-hidden">
                    <!-- SVG icon -->
            ...
            <li class="flex-1">
                <a href="#" data-tab="declined" class="tab-link whitespace-nowrap relative flex items-center justify-center gap-2 px-2 py-2 bg-white rounded-t-md hover:text-blue-800 overflow-hidden">
                    <!-- SVG icon -->
            ...
            <li class="flex-1">
                <a href="#" data-tab="history" class="tab-link relative flex items-center justify-center gap-2 px-4 py-2 bg-white rounded-t-md hover:text-blue-800">
                    <!-- SVG icon -->

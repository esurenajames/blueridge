...
<div x-data="{ rows: [{}] }" class="bg-white mt-10 sm:rounded-lg pl-6 pr-6 mb-4 mx-auto max-w-screen-lg mt-7">
    <div class="px-8 mt-1 sm:rounded-lg pb-8">
                    ...
                    <table id="account-table" class="min-w-full bg-white border-gray-300 border rounded-lg">
                        <thead>
                            <tr>
                                ...
                                <th class="px-4 py-2 text-sm font-medium text-gray-700">Actions</th> <!-- New column for remove button -->
                            </tr>
                        </thead>
                        <tbody>
                            <template x-for="(row, index) in rows" :key="index">
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">
                                        <button @click="rows.splice(index, 1)" class="text-red-600 hover:text-red-800 font-medium text-sm">Delete</button> <!-- Remove button -->
                                    </td>
                                </tr>
                            </template>
                        </tbody>
    ...
    <div class="px-8 mt-1 sm:rounded-lg pb-8">
        ...
        <div class="col-span-2">
            ...
            <div class="overflow-x-auto mb-2">
              ...
              <!-- Submit Button -->
            <div class="flex justify-end w-full mt-4">
                <button class="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800 mt-2">Send PCB Request</button>
            </div>
        </div>

    ...
    <div class="py-16">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <div class="w-full p-8 lg:w-1/2">
                <h2 class="text-3xl font-extrabold text-gray-800 text-center mb-4">Enter Verification Code</h2>
                <p class="text-base text-gray-600 text-center mb-5">A verification code has been sent to your email. Please enter the code below.</p>
                ...
                <div class="mt-8">
                    <a href="{{ route('reset') }}"><button class="bg-gray-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600">Verify Code</button></a>
                </div>
